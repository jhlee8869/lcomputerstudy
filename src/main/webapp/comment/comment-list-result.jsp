...
<h1>자유게시글 </h1>
	...
	<input type="hidden" name="c_order" value="${board.comment.c_group}">
	<input type="hidden" name="c_depth" value="${board.comment.c_group}">
	...
	<input type="hidden" name="b_idx" value="${board.b_idx}">
		<div id="div_body2">
			<textarea rows="7" cols="80" id="${board.comment.c_group}" name="c_content" form="${board.comment.c_group}" placeholder="댓글을 입력해주세요."></textarea>
		</div>
		<div id="div_body3">
			<div id="div_bd3" class="div_bd_comment">
				<a href="comment-list-process.do">댓글달기</a>
			</div>
		</div>
	</div>
